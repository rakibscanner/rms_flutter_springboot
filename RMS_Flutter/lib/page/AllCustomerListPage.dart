...
class AllCustomerListPage extends StatefulWidget {
  const AllCustomerListPage({super.key});

  @override
  State<AllCustomerListPage> createState() => _AllCustomerListPageState();
}

class _AllCustomerListPageState extends State<AllCustomerListPage> {
